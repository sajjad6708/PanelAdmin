<header class="navbar navbar-expand-md d-print-none">
    <div class="container-xl">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="#">
                <img src="{{ asset("./tabler-v1.0.0-beta20/static/logo.svg") }}" width="110" height="32" alt="Tabler" class="navbar-brand-image">
            </a>
        </h1>
                ...
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                   aria-label="Open user menu">
                    <span class="avatar avatar-sm"
                          style="background-image: url({{ asset("./tabler-v1.0.0-beta20/dist/img/payments/profile.jfif") }})"></span>
...
<header class="navbar-expand-md">
    <div class="collapse navbar-collapse" id="navbar-menu">
        <div class="navbar">
            <div class="container-xl">
                <ul class="navbar-nav">
                    <li class="nav-item @if(\Illuminate\Support\Facades\Route::currentRouteName() === "home.index") active @endif">
                    ...
                    <li class="nav-item @if(\Illuminate\Support\Facades\Route::currentRouteName() === "users.index") active @endif">
                        <a class="nav-link" href="#">
                            <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    ...
                    <li class="nav-item @if(\Illuminate\Support\Facades\Route::currentRouteName() === "categories.index") active @endif">
                        <a class="nav-link" href="#">
                            <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    ...
                    <li class="nav-item @if(\Illuminate\Support\Facades\Route::currentRouteName() === "comments.index") active @endif">
                        <a class="nav-link" href="#">
                            <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
